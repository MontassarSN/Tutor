...
export default function CourseRequirements({ requirements, setRequirements, data }: CourseRequirementsProps) {
  useEffect(() => {
  ...
  return (
    <div className='flex flex-col gap-3 py-5'>
      <div className='flex justify-between w-full'>
        <div className="text-lg font-semibold">Target Requirements ({requirements.length}/8)</div>
