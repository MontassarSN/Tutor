...
export default function CourseAudience({ audience, setAudience, data }: CourseAudienceProps) {
  useEffect(() => {
  ...
  return (
    <div className='flex flex-col gap-3 py-5'>
      <div className='flex justify-between w-full'>
        <div className="text-lg font-semibold">Target Audience ({audience.length}/8)</div>
        {audience.length < 8 && (
          <button
