...
export default function Features() {
  return (
    <div className="w-5/6 bg-white shadow-sm mx-auto py-10 mt-10">
      <div className="flex flex-col w-full">
        <div className="flex flex-row justify-between items-center pb-10  px-32">
        ...
        <div className="flex flex-row  w-full flex-wrap gap-10 justify-center">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex flex-row w-[42%] gap-1 items-center py-2"
            >
              <Image
                src={feature.pic}
                alt="Course"
              ...
              <div className="w-full px-4 flex flex-col gap-2">
                <div className="flex flex-row justify-between">
                  <div className={`text-xs px-2 py-1 ${feature.colors}`}>
                    {feature.label}
                  </div>
                  <div className="text-semibold text-gray-900">
                    {feature.CurrentPrice}
                    <span className="text-xs text-gray-400 line-through">
                      {feature.PreviousPrice}
                    </span>
                  </div>
                </div>
