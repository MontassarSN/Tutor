...
export default function TopInstructors() {
  ...
  return (
    <div className="flex flex-col mt-10 gap-5 w-3/4 m-auto items-center py-5 justify-center bg-white shadow-sm p-4">
      ...
      <div className="flex flex-row justify-center w-full flex-wrap gap-5">
        {Top5instructors?.map(
          (instructor: Tables<"instructors">, index: number) => (
            <InstructorCard
              key={index}
